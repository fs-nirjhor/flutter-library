...
const SingleScreen = ({ screen }) => {
  return (
    <figure className="group relative w-full aspect-[1/2] rounded-2xl shadow">
      ...
      />
      <div className="hidden group-hover:flex justify-around gap-5 items-end absolute z-10 bottom-0 right-0 w-full h-1/2 pb-5 bg-gradient-to-t from-gray-800 text-sm rounded-2xl">
